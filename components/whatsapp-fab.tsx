...
export default function WhatsAppFab({
  ...
  return (
    <Link
      ...
      className={cn(
        "fixed bottom-20 right-4 z-50 flex items-center justify-center w-12 h-12 rounded-full bg-white text-black shadow-lg hover:bg-gray-100 transition-all duration-200",
        className,
      )}
    >
